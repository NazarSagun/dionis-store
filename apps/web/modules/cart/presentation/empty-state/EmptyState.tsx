...
import { useCloseCartDrawer } from '../../core/facade'

export const EmptyState = () => {
  const { push } = useRouter()
  const closeDrawer = useCloseCartDrawer()
  return (
    <div className='flex flex-col items-center justify-center gap-4 rounded-md border border-ink bg-panel-alt px-0 py-8 text-foreground'>
